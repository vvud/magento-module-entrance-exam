<?php
namespace AHT\DeliveryDate\Model;
...
{
    const XPATH_FORMAT = 'AHT_deliverydate/general/format';
    const XPATH_DISABLED = 'AHT_deliverydate/general/disabled';
    const XPATH_HOURMIN = 'AHT_deliverydate/general/hourMin';
    const XPATH_HOURMAX = 'AHT_deliverydate/general/hourMax';
